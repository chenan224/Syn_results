<?php
 ...
 if($_POST["addclass"] == 1 && $_POST["title"] != "" && $_POST["teacher"] != "" && $_POST["semester"] != "" && $_POST["roomnum"] != "" && $_POST["periodnum"] != "")
 {
  ...
  $query = mysql_query("INSERT INTO courses (semesterid, termid, coursename, teacherid, sectionnum, roomnum, periodnum, dotw, substituteid) VALUES( '$_POST[semester]', '$termid', '$_POST[title]', '$_POST[teacher]', '$_POST[sectionnum]', '$_POST[roomnum]', '$_POST[periodnum]','$dotw','$_POST[substitute]')")
  ...
  else
  {
   ...
   $query = mysql_query("INSERT INTO courses (semesterid, termid, coursename, teacherid, sectionnum, roomnum, periodnum, dotw, substituteid) VALUES( '$_POST[semester2]', '$termid', '$_POST[title]', '$_POST[teacher]', '$_POST[sectionnum]', '$_POST[roomnum]', '$_POST[periodnum]','$dotw','$_POST[substitute]')")
	or die("ManageClasses.php: Unable to insert new class - " . mysql_error());
