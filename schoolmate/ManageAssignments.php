<?php
 ...
 if($_POST["addassignment"] == 1)
 {
  if($_POST["title"] != "" && $_POST["total"] != "" && $_POST["assigneddate"] != "" && $_POST["duedate"] != "")
  {
   ...
   $query = mysql_query("INSERT INTO assignments (courseid, semesterid, termid, title, totalpoints, assigneddate, duedate, assignmentinformation)  VALUES( '$_POST[selectclass]', '$ids[0]', '$ids[1]', '$_POST[title]', '$_POST[total]', '$_POST[assigneddate]', '$_POST[duedate]', '$_POST[task]')")
